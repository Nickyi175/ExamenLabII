 ...
 * @author tomea
 */
public class SubMenuF extends javax.swing.JFrame {
    ...
    TipoRedSocial2 type;
    public SubMenuF(TipoRedSocial2 type) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubMenuF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubMenuF(null).setVisible(true);
            }
        });
    }
